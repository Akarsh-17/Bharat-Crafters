...
const ProductDescriptionPage = () => {
  ...
  const handleMouseMove = (e) => {
    ...
    setZoomStyle({
      ...
      marginLeft: `${
        -offsetX + (containerRect.width * zoom - containerRect.width) * x
      }px`,
      marginTop: `${
        -offsetY + (containerRect.height * zoom - containerRect.height) * y
      }px`,
    });
  };
  ...
  function renderSkeletons(count) {
    ...
    for (let i = 0; i < count; i++) {
      skeletons.push(
        <div
          key={i}
          className="product-photo-options-images loadingEffects"
        ></div>
      );
    }
    ...
    <>
      ...
      <div className="product-details-outer-container" id="product-detail-page">
        <div className="product-photo-container">
                ...
                {ProductDetails.images &&
                  ProductDetails.images.map((image, key) => (
                    <img
                      src={image}
                      alt="Product"
                      className="product-photo-options-images"
                      key={key}
                      onClick={(e) => {
                        handleImageChange(e);
                      }}
          ...
          <div
            className={` ${
              isLoading ? "loadingEffects" : "product-display-image"
            }`}
          >
            <img
              className={`zoom-icon-img  ${
                ZoomIcon ? "zoomIconImgVisible" : ""
              }`}
              src={zoomIconImg}
              onClick={(e) => {
                handleZoomClick(
            ...
            <img
              ...
              alt="Product"
              className="product-display-image-photo"
              onMouseMove={(e) => {
                handleMouseMove(e);
              }}
              onClick={(e) => {
        ...
        <div className="product-details-container">
                    ...
                    <>
                      ...
                      >
                        ...
                        <div className="product-size-option">
                          {option.size.charAt(0).toUpperCase()} - {option.color}
                        </div>
                      </div>
                    </>
                  ))}
          ...
          <div className="product-main-details">
            <div className="product-details">
              <ul>
                <li className="product-description-detail-list">
                  This consists of : {ProductDetails.components}
                </li>
                <li className="product-description-detail-list">
                  Color : {SelectedColor}
                </li>
          ...
          <div className="product-seller-container">
            <div>
              ...
              <span class="product-seller">
                {ProductDetails.seller && ProductDetails.seller.firstName}{" "}
                {ProductDetails.seller && ProductDetails.seller.lastName}
              </span>
            </div>
            <button
              className="send-a-message"
              onClick={() => handleMessageSubmit(ProductDetails)}
            >
              <img src={sendMessageIcon} className="send-message-icon"></img>
              Message
            </button>
          </div>
      ...
      <div className="product-description-container">
        ...
        <ul className="product-description-list">
          <li>
            <span className="product-list-heading">Style : </span>
            {ProductDetails.style}
          </li>
          <li>
            <span className="product-list-heading">Pattern : </span>
            {ProductDetails.pattern}
          </li>
          <li>
            <span className="product-list-heading">Material : </span>
            {ProductDetails.material}
          </li>
          <li>
            <span className="product-list-heading">Additional Details : </span>
            <br></br>
            {ProductDetails.specialFeatures &&
              ProductDetails.specialFeatures.map((feature, key) => (
                <li>{feature}</li>
              ))}
          </li>
        </ul>
      ...
      <div className="more-products-like-this-section">
        <div className="more-products-like-this-heading">
            ...
            >
              <div className="product-image-container">
                ...
                <button
                  ...
                  onClick={() => {
                    handle_add_to_wishlist(product._id);
                  }}
                >
                  <img
                    src={
